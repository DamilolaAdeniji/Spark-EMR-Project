...
data "aws_iam_policy_document" "stfn_policy" {
  statement {
    ...
    resources = [
                "arn:aws:events:eu-north-1:340752803932:rule/StepFunctionsGetEventsForEMRServerlessApplicationRule",
                "arn:aws:emr-serverless:eu-north-1:340752803932:/applications/*",
                "*"
    ] 
  }
  statement {
